  ...
  <div class="container">
    <header class="header">
      ...
      <div class="social">
        ...
        <a href="https://instagram.com/pin2patra"><i class="fab fa-instagram"></i></a>
    ...
    <aside class="left">
      ...
      <br><br>
      <p>"Do something important in life."<br>- Mr Pintu Patra</p>
    </aside>
    <main class="content">
      <h2>About Me</h2>
      <p>Personal Trenar</p>
      <h2>My Career</h2>
      <p>I work as a web developer for a company that makes websites for businesses.</p>
      <hr><br>
